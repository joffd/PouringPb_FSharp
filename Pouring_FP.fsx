...
module FP =
    ...
    module Solver =
        ...
        let solve (pb: Problem) =
            ...
            pathSets
            |> LazyList.iter (fun paths -> 
                            paths
                            |> Set.iter (fun path -> printfn "%A" path.EndStatus))
            printfn "%i" (pathSets.Length())
            seq {
...
let pb1 = {
    FP.Solver.Setup = FP.Solver.CapacityInitStatus [|(7, 2) ; (9, 0) ; (5, 0)|]
    FP.Solver.Target = 8
}

FP.Printer.solvePrint pb1

let pb2 = {
    FP.Solver.Setup = FP.Solver.CapacityAllEmpty [|3 ; 7|]
    FP.Solver.Target = 8
}

FP.Printer.solvePrint pb2


let pb3 = {
    FP.Solver.Setup = FP.Solver.CapacityAllEmpty [|4;3 ; 7|]
    FP.Solver.Target = 5
}

FP.Printer.solvePrint pb3

let pb4 = {
    FP.Solver.Setup = FP.Solver.CapacityAllEmpty [|1 ; 3|]
    FP.Solver.Target = 2
}

FP.Printer.solvePrint pb4
